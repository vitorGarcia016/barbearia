<html lang="en">
  ...
  <body>
    ...
    <script src="{{asset('https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/js/bootstrap.bundle.min.js')}}" 
    ...
    <script src="{{asset('https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/js/bootstrap.min.js')}}" integrity="sha384-G/EV+4j2dNv+tEPo3++6LCgdCROaejBqfUeNjuKAiuXbjrxilcCdDz6ZAVfHWe1Y" crossorigin="anonymous"></script>
  </body>
</html>
